                  ...
                  <TableBody>
                    ...
                    {((actualByGroup["Sin Agrupadora"] ?? 0) > 0 || (committedByGroup["Sin Agrupadora"] ?? 0) > 0) && (
                      <TableRow>
                        ...
                        <TableCell className="text-right tabular-nums text-sm font-medium text-[#e3e3ea]">
                          {formatCLP(
                ...
                <TableBody>
                  {unmatchedTransactions.map((tx) => (
                      <TableRow key={tx.id}>
                        ...
                        <TableCell className="text-right tabular-nums text-sm font-medium text-[#e3e3ea] pr-5">
                          {formatCLP(tx.amount)}
                        </TableCell>
                      </TableRow>
                  ))}
