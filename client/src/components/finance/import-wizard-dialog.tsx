...
const STEPS: { key: WizardStep; n: number; label: string }[] = [
  { key: "import", n: 1, label: "Importar cartola" },
  { key: "review", n: 2, label: "Revisar y confirmar" },
];

/**
 * Wizard de importación en pop-up (paso 1 importar → paso 2 revisar/confirmar).
 *
